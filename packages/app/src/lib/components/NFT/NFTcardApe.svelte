<script lang="ts">
  ...
  import Scene from "./SceneApe.svelte";
...
<div bind:this={card} class="card" on:mousemove={handleHover} on:mouseleave={resetStyles}>
  ...
  <img src="/img/nft-placeholders/ape.png" class="absolute bottom-0 right-0 m-4 w-16" />
  <div class="content p-4">
    <div id="test" class="flex justify-between">
      <div class="leading-3">
        <h2 class="mb-1 text-[14pt] font-bold">BORED APE #387</h2>
        <h2 class="mb-2 text-[8pt] font-bold">283 / 1024</h2>
        <p class="text-[9pt] font-bold">ATTRIBUTES</p>
        <p class="text-[8pt] font-bold ">Toothpick - 12%</p>
        <p class="text-[8pt] font-bold ">3D Glasses - 4%</p>
        <p class="text-[8pt] font-bold ">Sailor Hat - 2%</p>
        <p class=" mt-2 text-[7pt] text-neutral-400">ORIGINAL RESOLUTION: 516 X 516</p>
        <p class=" text-[7pt] text-neutral-400">SEGMENT RESOLUTION: 32 X 32</p>
